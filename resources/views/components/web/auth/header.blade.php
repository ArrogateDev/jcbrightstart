            ...
            <div class="header-btn d-flex align-items-center">
                <div class="dropdown flag-dropdown icon-btn d-none">
                    <a href="javascript:void(0);" class="d-inline-flex align-items-center"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{web_resource_url('assets/admin/img/flags/us-flag.svg')}}" alt="flag">
                    </a>
                    <ul class="dropdown-menu p-2 mt-2">
                        <li>
                            <a class="dropdown-item rounded d-flex align-items-center"
...
{{--								<span class="avatar">--}}
{{--									<img src="{{web_resource_url('assets/admin/img/user/user-01.jpg')}}" alt="Img" class="img-fluid rounded-circle">--}}
{{--								</span>--}}
{{--                        </a>--}}
{{--                        <div class="dropdown-menu dropdown-menu-end">--}}
{{--                            <div class="profile-header d-flex align-items-center">--}}
{{--                                <div class="avatar">--}}
{{--                                    <img src="{{web_resource_url('assets/admin/img/user/user-01.jpg')}}" alt="Img"--}}
