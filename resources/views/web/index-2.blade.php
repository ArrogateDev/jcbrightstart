...
<div class="main-wrapper">
    ...
    <div class="banner-section-two">
        <div class="container position-relative">
            <img src="{{web_resource_url('assets/img/banner/star-01.png')}}" alt="img" class="img-fluid star-01">
            <img src="{{web_resource_url('assets/img/banner/star-02.png')}}" alt="img" class="img-fluid star-02">
            <img src="{{web_resource_url('assets/img/banner/star-03.png')}}" alt="img" class="img-fluid star-03">
            <img src="{{web_resource_url('assets/img/banner/star-04.png')}}" alt="img" class="img-fluid star-04">
            <img src="{{web_resource_url('assets/img/banner/star-05.png')}}" alt="img" class="img-fluid star-05">
            <img src="{{web_resource_url('assets/img/icons/banner-book.svg')}}" alt="img" class="img-fluid star-06 d-none d-xl-flex">
            <img src="{{web_resource_url('assets/img/icons/banner-icon-03.svg')}}" alt="img" class="img-fluid star-07 d-none d-xl-flex">
            <img src="{{web_resource_url('assets/img/icons/banner-icon-01.svg')}}" alt="img" class="img-fluid star-08 d-none d-xl-flex">
            <img src="{{web_resource_url('assets/img/icons/banner-icon-02.svg')}}" alt="img" class="img-fluid star-09 d-none d-xl-flex">
            <img src="{{web_resource_url('assets/img/icons/banner-icon-04.svg')}}" alt="img" class="img-fluid star-10 d-none d-xl-flex">
            <img src="{{web_resource_url('assets/img/banner/soft-star.png')}}" alt="img" class="img-fluid star-11 d-none d-xl-flex">
            <div class="row align-items-end">
                        ...
                        <div class="aos" data-aos="zoom-in">
                            <div class="banner-info">
                                    <span class="d-inline-flex fw-semibold text-uppercase mb-3">The Leader in Online
                                        Learning</span>
                                <h1 class="mb-4">Engaging & Accessible <span
                                        class="position-relative banner-title">Online <img
                                            src="{{web_resource_url('assets/img/banner/banner-text-bg.png')}}" alt="img"
                                            class="img-fluid position-absolute title-bg"></span> Courses For All
                                </h1>
                ...
                <div class="col-lg-6">
                    <div class="banner-img-section">
                        <img src="{{web_resource_url('assets/img/banner/banner-bg-01.png')}}" alt="img"
                             class="img-fluid banner-bg-01 d-none d-xl-flex aos" data-aos="fade-up"
                             data-aos-easing="linear" data-aos-duration="500">
                        <img src="{{web_resource_url('assets/img/banner/banner-bg-02.png')}}" alt="img"
                             class="img-fluid banner-bg-02 d-none d-xl-flex aos" data-aos="fade-up"
                             data-aos-easing="linear" data-aos-duration="600">
                        <img src="{{web_resource_url('assets/img/hero/hero-1.png')}}" alt="img" class="img-fluid banner-bg-03 aos"
    ...
    <div class="favorite-course">
            ...
            <div class="owl-carousel owl-theme nav-bottom px-1 category-carousel">
                <div class="item aos" data-aos="flip-right">
                    <div class="categories-item">
                        ...
                        <h5 class="fw-semi-bold mb-1"><a href="course-category.html">Management</a></h5>
                ...
                <div class="item aos" data-aos="flip-right">
                    <div class="categories-item">
                        ...
                        <h5 class="fw-semi-bold mb-1"><a href="course-category.html">IT & Softwares</a></h5>
                ...
                <div class="item aos" data-aos="flip-right">
                    <div class="categories-item">
                        ...
                        <h5 class="fw-semi-bold mb-1"><a href="course-category.html">Marketing</a></h5>
                ...
                <div class="item aos" data-aos="flip-right">
                    <div class="categories-item">
                        <div class="card-body text-center">
                            ...
                            <h5 class="fw-semi-bold mb-1"><a href="course-category.html">Productivity</a></h5>
                ...
                <div class="item aos" data-aos="flip-right">
                    <div class="categories-item">
                        <div class="card-body text-center">
                            ...
                            <h5 class="fw-semi-bold mb-1"><a href="course-category.html">Lifestyles</a></h5>
                            <p class="mb-0">214 Courses</p>
                        </div>
                    </div>
                </div>
                <div class="item aos" data-aos="flip-right">
                    <div class="categories-item">
                        <div class="card-body text-center">
                            ...
                            <h5 class="fw-semi-bold mb-1"><a href="course-category.html">Design</a></h5>
        ...
        <img src="{{web_resource_url('assets/img/bg/category-bg-1.png')}}" alt="img" class="bg-01">
    </div>
    <!-- /favorite  section -->
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="benefits-item">
                        <div class="benefits-img">
                            <img src="{{web_resource_url('assets/img/icons/benefit-icon-01.svg')}}" alt="img" class="img-fluid">
                        </div>
                        <h5 class="title">Stay motivated with instructors</h5>
                        <p class="text-light mb-0">Stay motivated with engaging instructors on our platform, guiding
                            you through every course.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="benefits-item">
                        <div class="benefits-img">
                            <img src="{{web_resource_url('assets/img/icons/benefit-icon-02.svg')}}" alt="img" class="img-fluid">
                        </div>
                        <h5 class="title">Get certified on courses</h5>
                        <p class="text-light mb-0">Get certified, master modern tech skills, and level up your
                            career whether you’re starting.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="benefits-item">
                        <div class="benefits-img">
                            <img src="{{web_resource_url('assets/img/icons/benefit-icon-03.svg')}}" alt="img" class="img-fluid">
                        </div>
                        <h5 class="title">Build skills on your way</h5>
                        <p class="text-light mb-0">Build skills your way with hands-on labs and immersive courses,
                            tailored to fit.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="feature-section position-relative">
        <div class="container">
            <img src="{{web_resource_url('assets/img/bg/feature-bg-01.png')}}" alt="img" class="bg-star-01 img-fluid">
            <img src="{{web_resource_url('assets/img/bg/feature-bg-02.png')}}" alt="img" class="bg-star-02 img-fluid">
            <div class="section-header text-center aos" data-aos="fade-up">
                    <span class="section-badge">
                        What’s New
                    </span>
            ...
            <div class="course-slider-slick">
                    ...
                    <div class="course-item-two course-item">
                        <div class="course-img">
                            ...
                            <div
                                ...
                                <a href="javascript:void(0);" class="brand-icon ms-auto">
                                    <img src="{{web_resource_url('assets/img/icons/course-01.svg')}}" alt="img" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        <div class="course-content">
                            ...
                            <p class="d-flex align-items-center mb-3"><i
                                    class="ti ti-star-filled text-warning me-2"></i>4.9 (200 Reviews)</p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h6 class="text-secondary fs-16 fw-semi-bold mb-0">$120</h6>
                                <a href="cart.html" class="btn btn-dark btn-sm d-inline-flex align-items-center">Add
                ...
                <div class="item">
                    <div class="course-item-two course-item">
                        <div class="course-img">
                            <a href="course-details.html">
                                <img src="{{web_resource_url('assets/img/course/course-23.jpg')}}" alt="img" class="img-fluid">
                            </a>
                            <div
                                class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                <a href="javascript:void(0);" class="fav-icon"><i class="isax isax-heart"></i></a>
                        ...
                        <div class="course-content">
                            <div class="d-flex justify-content-between mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <a href="instructor-details.html" class="link-default fs-14">David
                                            Benitz</a>
                                    </div>
                                </div>
                                <span
                            ...
                            <h6 class="title mb-2"><a href="course-details.html">The Complete Business and
                                    Management Course</a></h6>
                            <p class="d-flex align-items-center mb-3"><i
                                    class="ti ti-star-filled text-warning me-2"></i>5.0 (210 Reviews)</p>
                            <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="course-item-two course-item">
                        <div class="course-img">
                            ...
                            <div
                                ...
                                <a href="javascript:void(0);" class="fav-icon"><i class="isax isax-heart"></i></a>
                                <a href="javascript:void(0);" class="brand-icon ms-auto">
                                    <img src="{{web_resource_url('assets/img/featured-courses/react.svg')}}" alt="img" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        <div class="course-content">
                            <div class="d-flex justify-content-between mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <a href="instructor-details.html" class="link-default fs-14">Calvin
                                            Johnsen</a>
                                    </div>
                                </div>
                                <span
                            ...
                            <h6 class="title mb-2"><a href="course-details.html">Learn & Create ReactJS Tech
                                    Fundamentals Apps</a></h6>
                            <p class="d-flex align-items-center mb-3"><i
                                    class="ti ti-star-filled text-warning me-2"></i>5.0 (154 Reviews)</p>
                            <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="course-item-two course-item">
                        <div class="course-img">
                            ...
                            <div
                                ...
                                <a href="javascript:void(0);" class="fav-icon"><i class="isax isax-heart"></i></a>
                                <a href="javascript:void(0);" class="brand-icon ms-auto">
                                    <img src="{{web_resource_url('assets/img/featured-courses/Clip-path-group.svg')}}" alt="img"
                                         class="img-fluid">
                                </a>
                            </div>
                        </div>
                        <div class="course-content">
                            <div class="d-flex justify-content-between mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <a href="instructor-details.html" class="link-default fs-14">Edith
                                            Dorsey</a>
                                    </div>
                                </div>
                                <span
                            ...
                            <h6 class="title mb-2"><a href="course-details.html">Build Creative Arts & media Course
                                    Completed</a></h6>
                            <p class="d-flex align-items-center mb-3"><i
                                    class="ti ti-star-filled text-warning me-2"></i>4.9 (178 Reviews)</p>
                            <div class="d-flex align-items-center justify-content-between">
    ...
    <section class="counter-trending-cover">
        <div class="container">
            <div class="counter-section">
                <div class="section-header text-center aos" data-aos="fade-up">
                    <h2 class="text-white">Acheive you Goals with Jockey Club Bright Start Project</h2>
                    <p class="text-light">96% of eLearning for Business customers see improved results within six
                        months.</p>
                </div>
                ...
                <img src="{{web_resource_url('assets/img/bg/count-icon.png')}}" alt="img" class="img-fluid counter-bg-01 d-none d-lg-flex">
                <img src="{{web_resource_url('assets/img/icons/banner-icon-03.svg')}}" alt="img"
                     class="img-fluid counter-bg-02 d-none d-lg-flex">
            </div>
        </div>
        <div class="container position-relative">
                ...
                <div class="owl-carousel instructor-carousel owl-theme nav-bottom">
                        ...
                        <div class="instructor-item">
                            ...
                            <div class="instructor-img">
                                <a href="instructor-details.html">
                                    <img src="{{web_resource_url('assets/img/instructor/instructor-05.jpg')}}" alt="img">
                                    <span class="verify">
                    ...
                    <div class="item aos" data-aos="flip-right">
                        <div class="instructor-item">
                            ...
                            <div class="instructor-img">
                                <a href="instructor-details.html">
                                    <img src="{{web_resource_url('assets/img/instructor/instructor-06.jpg')}}" alt="img">
                                    <span class="verify">
                                            <img src="{{web_resource_url('assets/img/icons/verify-icon.svg')}}" alt="img" class="img-fluid">
                                        </span>
                                </a>
                    ...
                    <div class="item aos" data-aos="flip-right">
                        <div class="instructor-item">
                            ...
                            <div class="instructor-img">
                                <a href="instructor-details.html">
                                    <img src="{{web_resource_url('assets/img/instructor/instructor-07.jpg')}}" alt="img">
                                    <span class="verify">
                                            <img src="{{web_resource_url('assets/img/icons/verify-icon.svg')}}" alt="img" class="img-fluid">
                                        </span>
                                </a>
                            ...
                            <div class="instructor-content">
                                <h3 class="title">
                                    <a href="instructor-details.html">Ruben Holmesr</a>
                                </h3>
                    ...
                    <div class="item aos" data-aos="flip-right">
                        <div class="instructor-item">
                            ...
                            <div class="instructor-img">
                                <a href="instructor-details.html">
                                    <img src="{{web_resource_url('assets/img/instructor/instructor-08.jpg')}}" alt="img">
                                    <span class="verify">
                                            <img src="{{web_resource_url('assets/img/icons/verify-icon.svg')}}" alt="img" class="img-fluid">
                                        </span>
                                </a>
        ...
        <img src="{{web_resource_url('assets/img/bg/instructor-bg-1.png')}}" alt="img" class="instructor-bg">
    </section>
    <!-- /counter trending section -->
    ...
    <div class="subsribe-section">
        <div class="container position-relative">
            <img src="{{web_resource_url('assets/img/icons/banner-icon-03.svg')}}" alt="img" class="img-fluid bg-05  d-none d-lg-flex">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6 position-relative">
                    <img src="{{web_resource_url('assets/img/bg/subscribe-bg-01.png')}}" alt="img"
                         class="img-fluid bg-01 d-none d-lg-flex aos" data-aos="fade-down">
                    <img src="{{web_resource_url('assets/img/feature/feature-22.png')}}" alt="img"
                         class="img-fluid bg-02 d-none d-lg-flex aos" data-aos="fade-down">
                    <img src="{{web_resource_url('assets/img/icons/subscribe-icon-02.svg')}}" alt="img"
                         class="img-fluid bg-03 d-none d-lg-flex">
                    <img src="{{web_resource_url('assets/img/icons/subscribe-icon-01.svg')}}" alt="img"
                         class="img-fluid bg-04 d-none d-lg-flex">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="skill-image">
                        <div class="row position-relative">
                            <img src="{{web_resource_url('assets/img/bg/book-bg.png')}}" alt="img"
                                 class="img-fluid img-04 d-none d-xl-flex">
                            <img src="{{web_resource_url('assets/img/icons/icon-31.png')}}" alt="img"
                                 class="img-fluid img-05 d-none d-xl-flex">
                            <div class="col-md-6 d-flex">
                                <div class="flex-fill">
                                    <img src="{{web_resource_url('assets/img/feature/feature-26.jpg')}}" alt="img"
                                         class="img-fluid flex-fill img-01 aos" data-aos="fade-right">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <img src="{{web_resource_url('assets/img/feature/feature-27.jpg')}}" alt="img"
                                         class="img-fluid img-02 aos" data-aos="fade-down">
                                </div>
                                <div>
                                    <img src="{{web_resource_url('assets/img/feature/feature-28.jpg')}}" alt="img"
                                         class="img-fluid img-03 aos" data-aos="fade-up">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="skill-content">
                        ...
                        <div class="skill-list mb-4">
                            <p class="d-flex align-items-center"><i
                                    class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Access Your Class
                                anywhere</p>
                            <p class="d-flex align-items-center"><i
                                    class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Flexible Course Plan
                            </p>
                            <p class="d-flex align-items-center"><i
                                    class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Quality Assurance</p>
                            <p class="d-flex align-items-center"><i
                                    class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Cost-Effectiveness
                            </p>
                            <p class="d-flex align-items-center"><i
    ...
    <div class="cliets-section">
        <div>
            <div class="owl-carousel owl-theme brand-carousel">
                ...
                <div class="item">
                    <img src="{{web_resource_url('assets/img/client/14.svg')}}" alt="img">
                </div>
                <div class="item">
                    <img src="{{web_resource_url('assets/img/client/15.svg')}}" alt="img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about-us">
        <div class="container">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-7 aos" data-aos="fade-up">
                        <div class="about-us-head aos" data-aos="fade-up">
                            ...
                            <p>Read what our satisfied clients have to say about their experiences with our
                                platform.</p>
                        </div>
                        <div class="owl-carousel owl-theme nav-bottom" id="review-carousel">
                            <div class="item flex-fill">
                                <div class="review-item">
                                    ...
                                    <p>As an employer, the platform exceeded my expectations. We swiftly found
                                        top-tier talent for our company.</p>
                                    <div class="d-flex align-items-center review-user">
                                        <div class="me-2">
                                            <a href="student-details.html">
                                                <img src="{{web_resource_url('assets/img/user/user-06.jpg')}}" alt="img" class="img-fluid">
                                            </a>
                                        </div>
                                        <div>
                                            <h6 class=" fw-medium"><a href="student-details.html">Brenda Slaton</a>
                                            </h6>
                            ...
                            <div class="item flex-fill">
                                <div class="review-item">
                                    ...
                                    <p>The LMS made managing my coursework simple and engaging, with everything I
                                        need easily accessible and organized.</p>
                                    <div class="d-flex align-items-center review-user">
                                        <div class="me-2">
                                            <a href="student-details.html">
                                                <img src="{{web_resource_url('assets/img/user/user-12.jpg')}}" alt="img" class="img-fluid">
                                            </a>
                                        </div>
                                        <div>
                                            <h6 class=" fw-medium"><a href="student-details.html">Adrian Dennis</a>
                                            </h6>
                                            <p class="mb-0">Designer</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="img-section">
                            <img src="{{web_resource_url('assets/img/feature/feature-23.jpg')}}" alt="img" class="img-fluid about-img aos"
                                 data-aos="zoom-in">
                            <div class="enrolled-list-cover d-none d-xl-flex aos" data-aos="fade-down">
                                <div class="enrolled-list">
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-rounded">
                                                <img class="border border-white" src="{{web_resource_url('assets/img/user/user-35.jpg')}}"
                                                     alt="img">
                                            </span>
                                        <span class="avatar avatar-rounded">
                                                <img class="border border-white" src="{{web_resource_url('assets/img/user/user-09.jpg')}}"
                                                     alt="img">
                                            </span>
                                        <span class="avatar avatar-rounded">
                                                <img class="border border-white" src="{{web_resource_url('assets/img/user/user-06.jpg')}}"
                                                     alt="img">
                                            </span>
                                        <span class="avatar avatar-rounded">
                                                <img src="{{web_resource_url('assets/img/user/user-36.jpg')}}" alt="img">
                                            </span>
                                    </div>
                            ...
                            <img src="{{web_resource_url('assets/img/bg/arrow.png')}}" alt="img" class="img-fluid arrow d-none d-xl-flex">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="role-item aos" data-aos="fade-right">
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <p class="mb-4">Top global instructors teach millions of students on Mentoring.
                                    </p>
                                    <a href="become-an-instructor.html"
                                       class="btn btn-primary rounded-pill d-inline-flex align-items-center">Apply
                                        Now<i class="isax isax-arrow-right-3 ms-2"></i></a>
                                </div>
                                <div>
                                    <img src="{{web_resource_url('assets/img/instructor/instructor.png')}}" alt="img"
                        ...
                        <div class="role-item student-bg aos" data-aos="fade-up">
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <p class="mb-4">Start your educational journey with us and access a wealth of
                                        resources</p>
                                    <a href="student-list.html"
                                       class="btn btn-secondary rounded-pill d-inline-flex align-items-center">Enroll
                                        Now<i class="isax isax-arrow-right-3 ms-2"></i></a>
                                </div>
                                <div>
                                    <img src="{{web_resource_url('assets/img/students/student.png')}}" alt="img"
                                         class="img-fluid role-img d-none d-xl-flex">
                                </div>
                            </div>
                        </div>
            ...
            <img src="{{web_resource_url('assets/img/bg/about-bg-01.png')}}" alt="img" class="img-fluid about-bg-01 d-none d-xl-flex">
            <img src="{{web_resource_url('assets/img/bg/about-bg-02.png')}}" alt="img" class="img-fluid about-bg-02 d-none d-xl-flex">
        </div>
    </div>
    <!-- /about us -->
                        ...
                        <div class="accordion-item" data-aos="fade-up">
                            ...
                            <div id="collapsecustomicon1One" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body pt-0">
                                    <p>ArrogateLMS aims to provide you with a comprehensive and intuitive learning
            ...
            <div class="row row-gap-4 justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card aos" data-aos="zoom-in">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{web_resource_url('assets/img/blog/blog-22.jpg')}}" alt="img"
                                                             class="img-fluid"></a>
                        </div>
                        <div class="blog-content">
                            <h5><a href="blog-details.html">Mastering Programming with a Technical Mentor</a></h5>
                            <p>Learning to code can be overwhelming, but a mentor can make the journey smoother....
                            </p>
                            <div class="blog-user d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar me-2">
                                        <img src="{{web_resource_url('assets/img/user/user-42.jpg')}}" alt="img" class="img-fluid">
                                    </a>
                                    <p class="mb-0 d-flex align-items-center">by <a href="javascript:void(0);"
                                                                                    class="fw-medium ms-1">Reni Sarow</a></p>
                                </div>
                                <p class="d-flex align-items-center"><i
                                        class="isax isax-calendar-1 text-gray-7"></i>09 Aug 2025</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{web_resource_url('assets/img/blog/blog-23.jpg')}}" alt="img"
                                                             class="img-fluid"></a>
                        </div>
                        <div class="blog-content">
                            <h5><a href="blog-details.html">How to Level Up Your Coding Skills with the Help of a
                                    Mentor</a></h5>
                            <p>Whether you're a beginner or an advanced coder, this blog will explore how....</p>
                            <div class="blog-user d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar me-2">
                                        <img src="{{web_resource_url('assets/img/user/user-36.jpg')}}" alt="img" class="img-fluid">
                                    </a>
                                    <p class="mb-0 d-flex align-items-center">by <a href="javascript:void(0);"
                                                                                    class="fw-medium ms-1">Chris Daniel</a></p>
                                </div>
                                <p class="d-flex align-items-center"><i
                                        class="isax isax-calendar-1 text-gray-72"></i>15 Jul 2025</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{web_resource_url('assets/img/blog/blog-24.jpg')}}" alt="img"
                                                             class="img-fluid"></a>
                        </div>
                        <div class="blog-content">
                            <h5><a href="blog-details.html">Navigating the Tech World: The Ultimate Guide</a></h5>
                            <p> The tech industry is vast and ever-changing, but a mentor can help you stay
                                ahead.....</p>
                            <div class="blog-user d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar me-2">
                                        <img src="{{web_resource_url('assets/img/user/user-53.jpg')}}" alt="img" class="img-fluid">
                                    </a>
                                    <p class="mb-0 d-flex align-items-center">by <a href="javascript:void(0);"
                                                                                    class="fw-medium ms-1">Andrew</a></p>
                                </div>
                                <p class="d-flex align-items-center"><i
                                        class="isax isax-calendar-1 text-gray-7"></i>15 Jan 2025</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <img src="{{web_resource_url('assets/img/bg/feature-bg-02.png')}}" alt="img" class="img-fluid blog-bg-01">
        </div>
    </div>
    <!-- /blog section -->
                                ...
                                <div class="footer-widget footer-contact">
                                    ...
                                    <div class="footer-contact-info">
                                        <div class="footer-address d-flex align-items-center">
                                            ...
                                            <p> 7/F - 8/F,<br> HS Centre,<br>5 Lok Yip Road,<br>Fanling, N.T,<br>
                                                California,
                                                CA 94108 </p>
                                        </div>
                                        <div class="footer-address d-flex align-items-center">
                ...
                <div class="row row-gap-2">
                    <div class="col-md-6">
                        <div class="text-center text-md-start">
                            <p class="text-white">Copyright &copy; 2025 Jockey Club Bright Start Project. All rights reserved.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
