...
<div class="main-wrapper">
            ...
            <div class="header-nav">
                ...
                <div class="header-btn d-flex align-items-center">
                    <div class="dropdown flag-dropdown icon-btn d-none">
                        ...
                        <ul class="dropdown-menu p-2 mt-2 d-none">
                            <li>
                                <a class="dropdown-item rounded d-flex align-items-center"
                                   href="javascript:void(0);">
                                    <img src="{{web_resource_url('assets/img/flags/us-flag.svg')}}" class="me-2" alt="flag">ENG
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-7 col-md-12 d-flex col-12" data-aos="fade-down">
                    <div class="home-five-slide-face flex-fill">
                        <div class="home-five-slide-text">
								<span
                                    class="text-white d-inline-block bg-secondary small rounded-pill px-3 py-2 mb-3 mb-sm-4"><span
                                        class="badge bg-white text-secondary rounded-pill me-1">New</span>The Leader in
									Online Learning</span>
                            <h1>Engaging <span>&</span> Accessible Online Courses For All</h1>
                            <p>Our specialized online courses are designed to bring the classroom experience to you,
                ...
                <div class="offset-lg-1 col-lg-5 col-12 text-center" data-aos="fade-up">
                    <div class="banner-slide-img flex-fill aos">
                        <img class="img-fluid ps-lg-5" src="{{web_resource_url('assets/img/hero/hero-6.png')}}" alt="Img">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="align-items-center">
                                <div class="course-count-three course-count ms-0">
                                    <div class="course-img">
                                        <img class="img-fluid" src="{{web_resource_url('assets/img/icon/course-01.svg')}}" alt="Img">
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex" data-aos="fade-up">
                        <div class="course-details-three">
                            <div class="align-items-center">
                                <div class="course-count-three course-count ms-0">
                                    <div class="course-img">
                                        <img class="img-fluid" src="{{web_resource_url('assets/img/icon/course-02.svg')}}" alt="Img">
                                    </div>
                                    <div class="course-content-three">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex" data-aos="fade-up">
                        <div class="course-details-three">
                            <div class="align-items-center">
                                <div class="course-count-three course-count ms-0">
                                    <div class="course-img">
                                        <img class="img-fluid" src="{{web_resource_url('assets/img/icon/course-03.svg')}}" alt="Img">
                                    </div>
                                    <div class="course-content-three">
                        ...
                        <div class="course-details-three mb-0">
                            <div class="align-items-center">
                                <div class="course-count-three">
                                    <div class="course-img">
                                        <img class="img-fluid" src="{{web_resource_url('assets/img/icon/course-04.svg')}}" alt="Img">
                                    </div>
                ...
                <div class="col-xl-5 col-lg-6 col-md-12" data-aos="fade-up">
                    <div class="master-three-images">
                        <div class="master-img">
                            <img class="img-fluid master-bg1" src="{{web_resource_url('assets/img/shapes/shape-10.svg')}}" alt="img">
                            <img class="img-fluid master-bg2" src="{{web_resource_url('assets/img/shapes/shape-7.svg')}}" alt="img">
                            <img class="img-fluid master-skill-image1" src="{{web_resource_url('assets/img/feature/feature-10.jpg')}}"
                                 alt="img">
                            <div class="text-end">
                                <img class="img-fluid master-skill-image2" src="{{web_resource_url('assets/img/feature/feature-11.jpg')}}"
                                     alt="img">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="skils-group">
                            <div class="row row-gap-4">
                                <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-down">
                                    <div class="skils-icon-item">
                                        <div class="skils-icon">
                                            <img class="img-fluid" src="{{web_resource_url('assets/img/icon/career-01.svg')}}"
                                                 alt="certified">
                                        </div>
                                ...
                                <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-up">
                                    <div class="skils-icon-item">
                                        <div class="skils-icon">
                                            <img class="img-fluid" src="{{web_resource_url('assets/img/icon/career-02.svg')}}"
                                                 alt="Build skills">
                                        </div>
                                        <div class="skils-content">
                                ...
                                <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-up">
                                    <div class="skils-icon-item">
                                        <div class="skils-icon">
                                            <img class="img-fluid" src="{{web_resource_url('assets/img/icon/career-03.svg')}}"
                                                 alt="Stay Motivated">
                                        </div>
                                        <div class="skils-content">
                                ...
                                <div class="col-lg-6 col-xs-12 col-sm-6" data-aos="fade-up">
                                    <div class="skils-icon-item">
                                        <div class="skils-icon">
                                            <img class="img-fluid" src="{{web_resource_url('assets/img/icon/career-04.svg')}}"
                                                 alt="latest cloud">
                                        </div>
                                        <div class="skils-content">
                            ...
                            <div class="row align-items-center d-flex justify-content-between row-gap-4">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="see-all text-end">
                                        <a href="course-details.html">View All<i
                        ...
                        <div class="favourite-carousel">
                            <div class="categories-item categories-item-five" data-aos="fade-down">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="{{web_resource_url('assets/img/icon/favourite-01.svg')}}"
                                         alt="Angular Development">
                                </div>
                                <div class="category-info">
                                    <h3><a href="course-category.html">Angular Development</a></h3>
                                </div>
                                        ...
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                               data-bs-original-title="leader 1"><img
                                                    src="{{web_resource_url('assets/img/user/user-13.jpg')}}" alt="img"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                               data-bs-original-title="leader 2"><img
                                                    src="{{web_resource_url('assets/img/user/user-14.jpg')}}" alt="img"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                               data-bs-original-title="leader 3"><img
                                                    src="{{web_resource_url('assets/img/user/user-15.jpg')}}" alt="img"></a>
                                        </li>
                                        <li class="more-set">
                                            <a href="#">80+</a>
                                        </li>
                            ...
                            <div class="categories-item categories-item-five" data-aos="fade-down">
                                <div class="categories-icon">
                                    <img class="img-fluid" src="{{web_resource_url('assets/img/icon/favourite-02.svg')}}"
                                         alt="Angular Development">
                                </div>
                                <div class="category-info">
                                    <h3><a href="course-category.html">Pyhton Developmentt</a></h3>
                                </div>
                                <div class="instructors-info">
                                    <p class="me-4">Instructors</p>
                                    <ul class="instructors-list">
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                               data-bs-original-title="leader 1"><img
                                                    src="{{web_resource_url('assets/img/user/user-10.jpg')}}" alt="img"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                               data-bs-original-title="leader 2"><img
                                                    src="{{web_resource_url('assets/img/user/user-11.jpg')}}" alt="img"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                               data-bs-original-title="leader 3"><img
                                                    src="{{web_resource_url('assets/img/user/user-12.jpg')}}" alt="img"></a>
                                        </li>
                                        <li class="more-set">
                                            <a href="#">80+</a>
                                        </li>
                            ...
                            <div class="categories-item categories-item-five" data-aos="fade-down">
                                <div class="favourite-item flex-fill">
                                    <div class="categories-icon">
                                        <img class="img-fluid" src="{{web_resource_url('assets/img/icon/favourite-03.svg')}}"
                                             alt="NODE JS Development">
                                    </div>
                                    <div class="category-info">
                                        <h3><a href="course-category.html">NODE JS Development</a></h3>
                                    </div>
                                    <div class="instructors-info">
                                        <p class="me-4">Instructors</p>
                                        <ul class="instructors-list">
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 1"><img
                                                        src="{{web_resource_url('assets/img/user/user-07.jpg')}}" alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 2"><img
                                                        src="{{web_resource_url('assets/img/user/user-08.jpg')}}" alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 3"><img
                                                        src="{{web_resource_url('assets/img/user/user-09.jpg')}}" alt="img"></a>
                                            </li>
                                            <li class="more-set">
                                                <a href="#">80+</a>
                                            </li>
                            ...
                            <div class="categories-item categories-item-five" data-aos="fade-down">
                                <div class="favourite-item flex-fill">
                                    <div class="categories-icon">
                                        <img class="img-fluid" src="{{web_resource_url('assets/img/icon/favourite-04.svg')}}"
                                             alt="NODE JS Development">
                                    </div>
                                    <div class="category-info">
                                        <h3><a href="course-category.html">Corephp Development</a></h3>
                                    </div>
                                    <div class="instructors-info">
                                        <p class="me-4">Instructors</p>
                                        <ul class="instructors-list">
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 1"><img
                                                        src="{{web_resource_url('assets/img/user/user-04.jpg')}}" alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 2"><img
                                                        src="{{web_resource_url('assets/img/user/user-05.jpg')}}" alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 3"><img
                                                        src="{{web_resource_url('assets/img/user/user-06.jpg')}}" alt="img"></a>
                                            </li>
                                            <li class="more-set">
                                                <a href="#">80+</a>
                                            </li>
                            ...
                            <div class="categories-item categories-item-five" data-aos="fade-down">
                                <div class="favourite-item flex-fill">
                                    <div class="categories-icon">
                                        <img class="img-fluid" src="{{web_resource_url('assets/img/icon/favourite-05.svg')}}"
                                             alt="Angular Development">
                                    </div>
                                    <div class="category-info">
                                        <h3><a href="course-category.html">Laravel Development</a></h3>
                                    </div>
                                    <div class="instructors-info">
                                        <p class="me-4">Instructors</p>
                                        <ul class="instructors-list">
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 1"><img
                                                        src="{{web_resource_url('assets/img/user/user-01.jpg')}}" alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 2"><img
                                                        src="{{web_resource_url('assets/img/user/user-02.jpg')}}" alt="img"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                                   title="" data-bs-original-title="leader 3"><img
                                                        src="{{web_resource_url('assets/img/user/user-03.jpg')}}" alt="img"></a>
                                            </li>
                                            <li class="more-set">
                                                <a href="#">80+</a>
                                            </li>
                ...
                <div class="row">
                    <div class="home-five-head section-header-title" data-aos="fade-up">
                        <div class="row align-items-center d-flex justify-content-between row-gap-4">
                            ...
                            <div class="col-md-6">
                                <div class="see-all text-end">
                                    <a href="course-grid.html">View All<i class="fas fa-arrow-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="all-corses-main">
                        <div class="tab-content">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-35.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                            <a href="instructor-profile.html"><img
                                                                    src="{{web_resource_url('assets/img/user/user-02.jpg')}}" alt="Img"
                                                                    class="img-fluid"></a>
                                                        </div>
                                                        <div class="course-three-text">
                                                            <p>Pyhton Development</p>
                                                            <h3 class="title instructor-text"><a
                                                                    href="course-details.html">The Complete Web
                                                                    Developer PHP Course</a></h3>
                                                        </div>
                                                        <div class="student-counts-info d-flex align-items-center">
                                                            <img src="{{web_resource_url('assets/img/icon/student.svg')}}" alt="Img">
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-34.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                            <a href="instructor-profile.html"><img
                                                                    src="{{web_resource_url('assets/img/user/user-01.jpg')}}" alt="Img"
                                                                    class="img-fluid"></a>
                                                        </div>
                                                        <div class="course-three-text">
                                                            <p>Web Design</p>
                                                            <h3 class="title instructor-text"><a
                                                                    href="course-details.html">Build Responsive
                                                                    Websites with HTML</a></h3>
                                                        </div>
                                                        <div class="student-counts-info d-flex align-items-center">
                                                            <img src="{{web_resource_url('assets/img/icon/student.svg')}}" alt="Img">
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-28.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                            <a href="instructor-profile.html"><img
                                                                    src="{{web_resource_url('assets/img/user/user-03.jpg')}}" alt="Img"
                                                                    class="img-fluid"></a>
                                                        </div>
                                                        <div class="course-three-text">
                                                            <p>Business Management</p>
                                                            <h3 class="title instructor-text"><a
                                                                    href="course-details.html">The Complete Business
                                                                    Management Course</a></h3>
                                                        </div>
                                                        <div class="student-counts-info d-flex align-items-center">
                                                            <img src="{{web_resource_url('assets/img/icon/student.svg')}}" alt="Img">
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-29.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                            <a href="instructor-profile.html"><img
                                                                    src="{{web_resource_url('assets/img/user/user-04.jpg')}}" alt="Img"
                                                                    class="img-fluid"></a>
                                                        </div>
                                                        <div class="course-three-text">
                                                            <p>Creative Arts & media</p>
                                                            <h3 class="title instructor-text"><a
                                                                    href="course-details.html">Build Creative Arts &
                                                                    media Course Completed</a></h3>
                                                        </div>
                                                        <div class="student-counts-info d-flex align-items-center">
                                                            <img src="{{web_resource_url('assets/img/icon/student.svg')}}" alt="Img">
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-30.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                            <a href="instructor-profile.html"><img
                                                                    src="{{web_resource_url('assets/img/user/user-05.jpg')}}" alt="Img"
                                                                    class="img-fluid"></a>
                                                        </div>
                                                        <div class="course-three-text">
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-31.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                        ...
                                                        <div class="course-three-text">
                                                            <p>Pyhton Development</p>
                                                            <h3 class="title instructor-text"><a
                                                                    href="course-details.html">The Complete Pyhton
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-32.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                        ...
                                                        <div class="course-three-text">
                                                            <p>Business Management</p>
                                                            <h3 class="title instructor-text"><a
                                                                    href="course-details.html">Build Websites with
                                                                    HTML5 CSS3 Javascript</a></h3>
                                                        </div>
                                                        <div class="student-counts-info d-flex align-items-center">
                                                            <img src="{{web_resource_url('assets/img/icon/student.svg')}}" alt="Img">
                                                            <p class="ms-2">400 Students</p>
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                                                <div class="course-item course-item-five">
                                                    <div class="course-img">
                                                        <a href="instructor-profile.html"><img
                                                                src="{{web_resource_url('assets/img/course/course-33.jpg')}}" alt="Img"
                                                                class="img-fluid"></a>
                                                    </div>
                                                    <div class="course-content">
                                                        <div class="course-user-img">
                                                        ...
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-34.jpg')}}">
                                                            </a>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-01.jpg')}}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <img src="{{web_resource_url('assets/img/icon/student.svg')}}"
                                                                         alt="Img">
                                                                    <p>450 Students</p>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-35.jpg')}}">
                                                            </a>
                                                            <div class="heart-three">
                                                                <a href="#"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-02.jpg')}}"
                                                                            alt="Img" class="img-fluid"></a>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-28.jpg')}}">
                                                            </a>
                                                            <div class="heart-three">
                                                                <a href="#"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-03.jpg')}}"
                                                                            alt="Img" class="img-fluid"></a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="course-three-text">
                                                                <p>Business Management</p>
                                                                <h3 class="title instructor-text"><a
                                                                        href="course-details.html">The Complete
                                                                        Business Management Course</a></h3>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-29.jpg')}}">
                                                            </a>
                                                            <div class="heart-three">
                                                                <a href="#"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-04.jpg')}}"
                                                                            alt="Img" class="img-fluid"></a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="course-three-text">
                                                                <p>Creative Arts & media</p>
                                                                <h3 class="title instructor-text"><a
                                                                        href="course-details.html">Build Creative
                                                                        Arts & media Course Completed</a></h3>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-30.jpg')}}">
                                                            </a>
                                                            <div class="heart-three">
                                                                <a href="#"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-05.jpg')}}"
                                                                            alt="Img" class="img-fluid"></a>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-31.jpg')}}">
                                                            </a>
                                                            <div class="heart-three">
                                                                <a href="#"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-06.jpg')}}"
                                                                            alt="Img" class="img-fluid"></a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="course-three-text">
                                                                ...
                                                                <h3 class="title instructor-text"><a
                                                                        href="course-details.html">The Complete
                                                                        Pyhton Development Course</a></h3>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-32.jpg')}}">
                                                            </a>
                                                            <div class="heart-three">
                                                                <a href="#"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-07.jpg')}}"
                                                                            alt="Img" class="img-fluid"></a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="course-three-text">
                                                                <p>Business Management</p>
                                                                <h3 class="title instructor-text"><a
                                                                        href="course-details.html">Build Websites
                                                                        with HTML5 CSS3 Javascript</a></h3>
                                                ...
                                                <div class="course-box-three">
                                                    <div class="course-three-item">
                                                        <div class="course-three-img">
                                                            <a href="course-details.html">
                                                                <img class="img-fluid" alt="Img"
                                                                     src="{{web_resource_url('assets/img/course/course-33.jpg')}}">
                                                            </a>
                                                            <div class="heart-three">
                                                                <a href="#"><i class="fa-regular fa-heart"></i></a>
                                                            </div>
                                                        ...
                                                        <div class="course-three-content">
                                                            <div class="course-group-three">
                                                                <div class="group-three-img">
                                                                    <a href="instructor-profile.html"><img
                                                                            src="{{web_resource_url('assets/img/user/user-08.jpg')}}"
                                                                            alt="Img" class="img-fluid"></a>
                                                                </div>
                                                            </div>
                            ...
                            <div class="text-center mt-3">
                                <a href="course-grid.html" class="btn btn-secondary">View all Courses</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center justify-content-center row-gap-4">
                ...
                <div class="col-xl-3 col-lg-12 col-md-12" data-aos="fade-down">
                    <div class="acheive-goals-main">
                        <h2>Acheive you Goals with Jockey Club Bright Start Project</h2>
                    </div>
                </div>
                <!-- /Col -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-one">
                            <img src="{{web_resource_url('assets/img/icon/ellipse-1.svg')}}" alt="Img">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-two">
                            <img src="{{web_resource_url('assets/img/icon/ellipse-2.svg')}}" alt="Img">
                        </div>
                        <div class="acheive-goals-content text-center course-count ms-0">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-three">
                            <img src="{{web_resource_url('assets/img/icon/ellipse-3.svg')}}" alt="Img">
                        </div>
                        <div class="acheive-goals-content text-center course-count ms-0">
    ...
    <section class="accelerate-cloud-three">
        <div class="container">
            <div class="shapes-three-left">
                <img class="accelerate-three d-none d-lg-flex" src="{{web_resource_url('assets/img/shapes/shape-8.png')}}" alt="Img">
                <img class="accelerate-five" src="{{web_resource_url('assets/img/shapes/shape-9.png')}}" alt="Img">
            </div>
            <div class="section-header-title d-none" data-aos="fade-up">
                <div class="row align-items-center d-flex justify-content-between">
                    ...
                    <div class="col-lg-7 col-md-12">
                        <p class="text-white ms-lg-5 mb-4">96% of eLearning for Business customers see improved
            ...
            <div class="award-one">
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                        <div class="master-img">
                            <img class="img-fluid master-bg4" src="{{web_resource_url('assets/img/bg/shape-04.svg')}}" alt="img">
                            <img class="img-fluid master-bg5" src="{{web_resource_url('assets/img/bg/shape-05.svg')}}" alt="img">
                            <img class="img-fluid master-bg2" src="{{web_resource_url('assets/img/shapes/shape-7.svg')}}" alt="img">
                            <img class="img-fluid master-skill-image1" src="{{web_resource_url('assets/img/feature/feature-8.jpg')}}"
                                 alt="img">
                            <div class="text-end">
                                <img class="img-fluid master-skill-image2" src="{{web_resource_url('assets/img/feature/feature-9.jpg')}}"
                                     alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-6 col-md-6 col-12">
                        <div class="ms-lg-5 ps-lg-5">
                            <div class="mb-3">
                                <img src="{{web_resource_url('assets/img/icon/award.svg')}}" alt="certified">
                            </div>
                            <h2 class="text-warning my-4">Award Winning Course Management</h2>
                            <p class="text-white mb-4">An award-winning course management system (CMS) or program is
                                typically recognized for its exceptional quality, innovation, and effectiveness in
                                helping both instructors and students succeed.</p>
                            <!-- List -->
                            <ul class="list-unstyled text-white mb-5">
                                <li class="d-flex mb-3">
                                    <i class="isax isax-tick-circle5 text-warning fs-24 me-2"></i>Interactive Tools
                                    for Engagement
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="isax isax-tick-circle5 text-warning fs-24 me-2"></i>Customizable
                                    Course Creation
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-warning fs-24 me-2"></i>Robust Analytics
                                    and Reporting
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-warning fs-24 me-2"></i>Collaborative and
                                    Peer-to-Peer Learning
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-warning fs-24 me-2"></i>The Most World
                                    Class Instructors
                                </li>
                            </ul>
                        </div>
            ...
            <div class="learn-anything">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-7 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                        <div class="me-5 pe-5">
                            <div class="mb-3">
                                <img src="{{web_resource_url('assets/img/icon/time.svg')}}" alt="certified">
                            </div>
                            <h2 class="text-skyblue my-4">Learn anything from anywhere anytime</h2>
                            <p class="text-white mb-4">In today’s fast-paced, digital world, the ability to learn
                                anything, from anywhere, and at any time is more accessible than ever. Whether you
                                are looking to expand your knowledge, gain new skills.</p>
                            <!-- List -->
                            <ul class="list-unstyled text-white mb-5">
                                <li class="d-flex mb-3">
                                    <i class="isax isax-tick-circle5 text-skyblue fs-24 me-2"></i>Interactive Tools
                                    for Engagement
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="isax isax-tick-circle5 text-skyblue fs-24 me-2"></i>Customizable
                                    Course Creation
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-skyblue fs-24 me-2"></i>Robust Analytics
                                    and Reporting
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-skyblue fs-24 me-2"></i>Collaborative and
                                    Peer-to-Peer Learning
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-skyblue fs-24 me-2"></i>The Most World
                                    Class Instructors
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                        <div class="master-img mb-0">
                            ...
                            <img class="img-fluid master-bg5" src="{{web_resource_url('assets/img/bg/shape-05.svg')}}" alt="img">
                            <img class="img-fluid master-bg2" src="{{web_resource_url('assets/img/shapes/shape-7.svg')}}" alt="img">
                            <img class="img-fluid master-skill-image1" src="{{web_resource_url('assets/img/feature/feature-12.jpg')}}"
                                 alt="img">
                            <div class="text-end">
                                <img class="img-fluid master-skill-image2" src="{{web_resource_url('assets/img/feature/feature-13.jpg')}}"
                                     alt="img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                        <div class="master-img">
                            ...
                            <img class="img-fluid master-bg5" src="{{web_resource_url('assets/img/bg/shape-05.svg')}}" alt="img">
                            <img class="img-fluid master-bg2" src="{{web_resource_url('assets/img/shapes/shape-7.svg')}}" alt="img">
                            <img class="img-fluid master-skill-image1" src="{{web_resource_url('assets/img/feature/feature-5.jpg')}}"
                                 alt="img">
                            <div class="text-end">
                                <img class="img-fluid master-skill-image2" src="{{web_resource_url('assets/img/feature/feature-6.jpg')}}"
                                     alt="img">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-7 col-lg-6 col-md-6 col-12" data-aos="fade-up">
                        <div class="ms-lg-5 ps-lg-5">
                            <div class="mb-3">
                                <img src="{{web_resource_url('assets/img/icon/winning.svg')}}" alt="certified">
                            </div>
                            <h2 class="text-success my-4">Certification for solid development of your Career</h2>
                            <p class="text-white mb-4">Certifications are a powerful way to enhance your skills,
                                build credibility, and boost your career growth. In today’s competitive job market,
                                a professional certification.</p>
                            <!-- List -->
                            <ul class="list-unstyled text-white mb-5">
                                <li class="d-flex mb-3">
                                    <i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Demonstrates
                                    Expertise
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Boosts Your
                                    Credibility
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Improves Job
                                    Security
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Facilitates Career
                                    Advancement
                                </li>
                                <li class="d-flex mb-3" data-aos="fade-up">
                                    <i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Fosters Personal
                                    Growth
                                </li>
                            </ul>
                        </div>
                ...
                <div class="home-five-trending-course" data-aos="fade-up">
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-one">
                            <div class="course-title-one">
                                <a href="course-details.html">SEO, Marketing</a>
                            </div>
                            <div class="trending-three-text">
                                <h3 class="title instructor-text"><a href="course-details.html">Digital Marketing
                                        Strategies for Successfull Business Growth</a></h3>
                            ...
                            <div class="trending-counts-info d-flex align-items-center justify-content-between">
                                <div class="trending-three-counts d-flex align-items-center">
                                    <img src="{{web_resource_url('assets/img/icon/student-icon.svg')}}" alt="student-icon">
                                    <p>400 Students</p>
                                </div>
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="course-details.html"><img src="{{web_resource_url('assets/img/user/user-01.jpg')}}"
                                                                       alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-two">
                            <div class="course-title-one">
                                <a href="course-details.html">Personalised Learning</a>
                            </div>
                            <div class="trending-three-text">
                                <h3 class="title instructor-text"><a href="course-details.html">Starting Your Own
                                        Business: From Idea to Launch</a></h3>
                                <p>Learn how mentorship can help guide your decision-making process</p>
                            </div>

                            <div class="trending-counts-info d-flex align-items-center justify-content-between">
                                <div class="trending-three-counts d-flex align-items-center">
                                    <img src="{{web_resource_url('assets/img/icon/student-icon.svg')}}" alt="Img">
                                    <p>900 Students</p>
                                </div>
                                <div class="price-three-time d-inline-flex align-items-center">
                                    <i class="fa-regular fa-clock me-2"></i>
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="course-details.html"><img src="{{web_resource_url('assets/img/user/user-02.jpg')}}"
                                                                       alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-three">
                            ...
                            <div class="trending-three-text">
                                <h3 class="title instructor-text"><a href="course-details.html">Financial Literacy:
                                        Managing Your Money for Long-Term Growth</a></h3>
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="course-details.html"><img src="{{web_resource_url('assets/img/user/user-03.jpg')}}"
                                                                       alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-four">
                            ...
                            <div class="trending-three-text">
                                <h3 class="title instructor-text"><a href="course-details.html">The Complete Web
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="course-details.html"><img src="{{web_resource_url('assets/img/user/user-04.jpg')}}"
                                                                       alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="course-details.html"><img src="{{web_resource_url('assets/img/user/user-05.jpg')}}"
                                                                       alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        <div class="trending-content-top trending-bg-two">
                            ...
                            <div class="trending-three-text">
                                <h3 class="title instructor-text"><a href="course-details.html">Financial Literacy:
                                        Managing Your Money for Long-Term</a></h3>
                                <p>Learn how mentorship can help guide your decision-making process </p>
                            </div>
                            <div class="trending-counts-info d-flex align-items-center justify-content-between">
                                <div class="trending-three-counts d-flex align-items-center">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="course-details.html"><img src="{{web_resource_url('assets/img/user/user-06.jpg')}}"
                                                                       alt="img"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trending-three-item">
                        ...
                        <div class="trending-content-footer">
                            <div class="trending-price-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="trending-footer-img">
                                    <a href="course-details.html"><img src="{{web_resource_url('assets/img/user/user-07.jpg')}}"
                                                                       alt="img"></a>
                                </div>
                            </div>
                        </div>
    ...
    <section class="gallery-three">
        <img class="gallery-bg d-none d-lg-flex" src="{{web_resource_url('assets/img/shapes/shape-11.svg')}}" alt="img">
        <div class="container">
            <div class="home-five-head section-header-title" data-aos="fade-up">
                <div class="row align-items-center d-flex justify-content-between row-gap-4">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="see-all text-end">
                            <a href="instructor-list.html">View all<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="courses-gallery-three">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5">
                        <div class="row">
                            <div class="col-lg-7 col-md-7 d-flex">
                                <div class="instructor-item instructor-item-five">
                                    <div class="instructors-img">
                                        <img src="{{web_resource_url('assets/img/instructor/instructor-13.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="instructor-overlay">
                                        ...
                                        <div class="instructor-content">
                                            <div>
                                                <h6><a href="instructor-details.html">David</a></h6>
                                                <p>Angular Js</p>
                                            </div>
                                            <div>
                                                <a href="instructor-details.html" class="view-link">
                            ...
                            <div class="col-lg-5 col-md-5 d-flex">
                                <div class="instructor-item instructor-item-five">
                                    <div class="instructors-img">
                                        <img src="{{web_resource_url('assets/img/instructor/instructor-14.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="instructor-overlay">
                                        <div
                                            class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        ...
                                        <div class="instructor-content">
                                            <div>
                                                <h6><a href="instructor-details.html">Maria</a></h6>
                                                <p>Node Js</p>
                                            </div>
                                            <div>
                                                <a href="instructor-details.html" class="view-link">
                            ...
                            <div class="col-lg-5 col-md-5 d-flex">
                                <div class="instructor-item instructor-item-five">
                                    <div class="instructors-img">
                                        <img src="{{web_resource_url('assets/img/instructor/instructor-15.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="instructor-overlay">
                                        <div
                                            class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        ...
                                        <div class="instructor-content">
                                            <div>
                                                <h6><a href="instructor-details.html">Richardson</a></h6>
                                                <p>React Js</p>
                                            </div>
                                            <div>
                                                <a href="instructor-details.html" class="view-link">
                            ...
                            <div class="col-lg-7 col-md-7 d-flex">
                                <div class="instructor-item instructor-item-five">
                                    <div class="instructors-img">
                                        <img src="{{web_resource_url('assets/img/instructor/instructor-16.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="instructor-overlay">
                                        <div
                                            class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        ...
                                        <div class="instructor-content">
                                            <div>
                                                <h6><a href="instructor-details.html">Patricia</a></h6>
                                                <p>Vue Js</p>
                                            </div>
                                            <div>
                                                <a href="instructor-details.html" class="view-link">
                    ...
                    <div class="col-lg-3 col-md-3 d-flex">
                        <div class="instructor-item instructor-item-five">
                            <div class="instructors-img">
                                <img src="{{web_resource_url('assets/img/gallery/gallery-5.jpg')}}" alt="Instructor">
                            </div>
                            <div class="instructor-overlay">
                                <div
                                    class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                ...
                                <div class="instructor-content">
                                    <div>
                                        <h6><a href="instructor-details.html">Hendriques</a></h6>
                    ...
                    <div class="col-lg-4 col-md-4 d-flex">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 d-flex">
                                <div class="instructor-item instructor-item-five">
                                    <div class="instructors-img">
                                        <img src="{{web_resource_url('assets/img/instructor/instructor-17.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="instructor-overlay">
                                        <div
                                            class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        ...
                                        <div class="instructor-content">
                                            <div>
                                                <h6><a href="instructor-details.html">Laura</a></h6>
                                                <p>UI/UX Designer</p>
                                            </div>
                                            <div>
                                                <a href="instructor-details.html" class="view-link">
                            ...
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="instructor-item instructor-item-five">
                                    <div class="instructors-img">
                                        <img src="{{web_resource_url('assets/img/instructor/instructor-18.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="instructor-overlay">
                                        <div
                                            class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        ...
                                        <div class="instructor-content">
                                            <div>
                                                <h6><a href="instructor-details.html">Morgon</a></h6>
                                                <p>Node Js</p>
                                            </div>
                                            <div>
                                                <a href="instructor-details.html" class="view-link">
                            ...
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="instructor-item instructor-item-five">
                                    <div class="instructors-img">
                                        <img src="{{web_resource_url('assets/img/instructor/instructor-19.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="instructor-overlay">
                                        <div
                                            class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                                        ...
                                        <div class="instructor-content">
                                            <div>
                                                <h6><a href="instructor-details.html">Brook</a></h6>
                                                <p>PHP Developer</p>
                                            </div>
                                            <div>
                                                <a href="instructor-details.html" class="view-link">
            ...
            <div class="row align-items-center row-gap-4">
                <div class="col-lg-8 col-md-8" data-aos="fade-up">
                    <div class="become-content-three">
                        ...
                        <p>Top instructors from around the world teach millions of students on Arrogate Maker
                            Limited.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4" data-aos="fade-up">
                    <div class="text-end">
                        <a href="register.html" class="btn btn-white">Join Our Community</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="m-0 p-0 lead-group aos" data-aos="fade-up">
                <div class="lead-group-slider owl-carousel owl-theme">
                    <div class="item">
                        <div class="lead-img">
                            <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-33.svg')}}">
                        </div>
                    </div>
                    <div class="item">
                        <div class="lead-img">
                            <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-34.svg')}}">
                        </div>
                    </div>
                    <div class="item">
                        <div class="lead-img">
                            <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-35.svg')}}">
                        </div>
                    </div>
                    <div class="item">
                        <div class="lead-img">
                            <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-36.svg')}}">
                        </div>
                    </div>
                    <div class="item">
                        <div class="lead-img">
                            <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-37.svg')}}">
                        </div>
                    </div>
                    <div class="item">
                        <div class="lead-img">
                            <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-38.svg')}}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="testimonial-three">
        <div class="container">
            <div class="testimonial-pattern">
                <img class="pattern-left img-fluid" alt="Img" src="{{web_resource_url('assets/img/bg/pattern-05.svg')}}">
            </div>
            <div class="testimonial-three-content">
                <div class="row align-items-center row-gap-4">
                    <div class="col-xl-6 col-lg-12 col-md-12" data-aos="fade-down">
                        ...
                        <a href="#" class="btn btn-white aos-init aos-animate" data-aos="fade-up">Join Our
                            Community</a>
                        <!-- View all Testimonail -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item-five">
                                        <div class="testimonial-quote">
                                            <img class="quote img-fluid" alt="Img" src="{{web_resource_url('assets/img/bg/quote.svg')}}">
                                        </div>
                                        <div class="testimonial-content">
                                            <p>I’ve become more organized, confident, and focused thanks to my life
                                                coach. They helped me set realistic goals and break them down into
                                                actionable steps. I’ve accomplished so much already!</p>
                                        </div>
                                        ...
                                        <div class="testimonial-users">
                                            <div class="imgbx">
                                                <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/user/user-01.jpg')}}">
                                            </div>
                                            <div class="d-block">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item-five">
                                        ...
                                        <div class="testimonial-content">
                                            <p>As a writer, I’ve learned so much about structure and storytelling
                                                from my mentor. Their feedback helped me tighten up my writing and
                                                make my characters more compelling.</p>
                                        </div>
                                        <div class="testimonial-ratings">
                                            <div class="rating">
                                                <i class="fas fa-star filled"></i>
                                        ...
                                        <div class="testimonial-users">
                                            <div class="imgbx">
                                                <img class="" alt="Img" src="{{web_resource_url('assets/img/user/user-02.jpg')}}">
                                            </div>
                                            <div class="d-block">
                                                <h6>Martin Harn</h6>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item-five">
                                        ...
                                        <div class="testimonial-content">
                                            <p>I often felt like the mentor’s answers were too detailed, which made
                                                it hard for me to keep up. Sometimes, a simpler explanation would
                                                have helped me understand things faster.</p>
                                        </div>
                                        <div class="testimonial-ratings">
                                            <div class="rating">
                                                <i class="fas fa-star filled"></i>
                                        ...
                                        <div class="testimonial-users">
                                            <div class="imgbx">
                                                <img class="" alt="Img" src="{{web_resource_url('assets/img/user/user-03.jpg')}}">
                                            </div>
                                            <div class="d-block">
                                                <h6>Noah Aarons</h6>
                                                <p>Business Man</p>
            ...
            <div class="home-five-head section-header-title pb-0" data-aos="fade-up">
                <div class="row align-items-center d-flex justify-content-between row-gap-4">
                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="see-all text-end">
                            <a href="blog-grid.html">View All<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="event-blog-three blog-three-one flex-fill">
                            <div class="blog-img-three">
                                <a href="blog-grid.html">
                                    <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/blog/blog-34.jpg')}}">
                                </a>
                            </div>
                    ...
                    <div class="row align-items-center gy-4">
                            ...
                            <div class="footer-widget-three footer-about">
                                ...
                                <div class="box-form-newsletter">
                                    <form class="form-newsletter">
                                        ...
                                        <button
                                            class="btn btn-secondary font-heading icon-send-letter">Subscribe
                                        </button>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6 d-lg-flex justify-content-end d-none d-lg-none">
                                    <!-- Footer Widget -->
                                    <div class="footer-widget-three footer-menu-three footer-three-right">
                ...
                <div class="row row-gap-3">
                    <div class="col-lg-4">
                        <div class="copyright-text">
                            <p>Copyright 2025 © <a href="javascript:void(0);">Jockey Club Bright Start Project</a>. All right
                                reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
