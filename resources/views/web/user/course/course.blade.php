        ...
        <div class="course-content">
            <div class="d-flex justify-content-between mb-2">
                <div class="d-flex align-items-center">
                    <a href="{{route('course.details.html',['course'=>$course->id])}}" class="avatar avatar-sm">
                        <img src="{{web_resource_url('assets/img/avatar.png')}}" alt="img"
                             class="img-fluid avatar avatar-sm rounded-circle">
                    </a>
                    <div class="ms-2">
                        <a href="{{route('course.details.html',['course'=>$course->id])}}" class="link-default fs-14">Brenda Slaton</a>
                    </div>
                </div>
            ...
            <p class="d-flex align-items-center mb-3">
                <i class="fa-solid fa-star text-warning me-2"></i>5.0 (999 Reviews)
            </p>
