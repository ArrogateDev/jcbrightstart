...
<div class="col-span-12 md:col-span-4 xl:col-span-3" >
    <div class="bg-[#d8d4cf57] rounded-lg p-[21px]">
        <a class="block bg-[#fff] rounded-lg p-[14px_21px]" href="{{$resource->url}}" data-category="{{$resource->category_id}}" data-pdf="{{$resource->pdf}}" data-description="@json($resource->description)">
