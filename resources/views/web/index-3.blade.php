	...
	<div class="main-wrapper">
		...
		<div class="home-3">
			...
			<section class="banner-section-three d-flex align-items-center">
				<img src="{{web_resource_url('assets/img/bg/bg-3.png')}}" alt="img" class="img-fluid banner-bg-01">
				<img src="{{web_resource_url('assets/img/bg/bg-4.png')}}" alt="img" class="img-fluid banner-bg-02">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="home-slide-face aos" data-aos="fade-up">
								<div class="home-slide-text ">
									...
									<h1 class="mt-4">Engaging & Accessible <span class="text-secondary">Online
											Courses</span> For All</h1>
									<p class="mt-4">Our specialized online courses are designed to bring the classroom
										experience to you, no matter where you are.</p>
								</div>
									...
									<form class="form" action="course-list.html">
										<div class="form-inner">
											<div class="input-group">
												...
												<button class="btn sub-btn" type="submit"><i
						...
						<div class="col-lg-6 d-flex align-items-center">
							<div class="banner-image aos" data-aos="fade-up">
								<img src="{{web_resource_url('assets/img/hero/hero-2.png')}}" alt="Img">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="course-widget">
						<div class="row row-gap-4">
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="{{web_resource_url('assets/img/icons/icon-24.svg')}}" alt="Img">
									</div>
							...
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="{{web_resource_url('assets/img/icons/icon-25.svg')}}" alt="Img">
									</div>
									<div class="expert-content">
							...
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="{{web_resource_url('assets/img/icons/icon-26.svg')}}" alt="Img">
									</div>
									<div class="expert-content">
							...
							<div class="col-lg-3 col-md-6 d-flex">
								<div class="expert-item flex-fill aos" data-aos="fade-up">
									<div class="expert-img">
										<img src="{{web_resource_url('assets/img/icons/icon-27.svg')}}" alt="Img">
									</div>
									<div class="expert-content">
			...
			<div class="section how-it-works">
				<div class="container">
					<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 aos"
						data-aos="fade-up">
						<div class="section-header">
							<span class="fw-medium text-secondary fs-18 fw-bold mb-2 d-inline-block">Favourite
								Course</span>
					...
					<div class="mentoring-course aos" data-aos="fade-up">
						<div class="categories-item categories-item-two">
							<span class="categories-icon">
								<img src="{{web_resource_url('assets/img/category/icons/icon-1.svg')}}" alt="Img">
							</span>
						...
						<div class="categories-item categories-item-two">
							<span class="categories-icon">
								<img src="{{web_resource_url('assets/img/category/icons/icon-2.svg')}}" alt="Img">
							</span>
						...
						<div class="categories-item categories-item-two">
							<span class="categories-icon">
								<img src="{{web_resource_url('assets/img/category/icons/icon-3.svg')}}" alt="Img">
							</span>
						...
						<div class="categories-item categories-item-two">
							<span class="categories-icon">
								<img src="{{web_resource_url('assets/img/category/icons/icon-4.svg')}}" alt="Img">
							</span>
						...
						<div class="categories-item categories-item-two">
							<span class="categories-icon">
								<img src="{{web_resource_url('assets/img/category/icons/icon-5.png')}}" alt="Img">
							</span>
			...
			<div class="section new-course">
				<div class="home-three-sec-bg">
					<img src="{{web_resource_url('assets/img/bg/bg-3.png')}}" alt="img" class="img-fluid sec-bg-01">
					<img src="{{web_resource_url('assets/img/bg/bg-4.png')}}" alt="img" class="img-fluid sec-bg-02">
				</div>
				<div class="container">
					<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 aos"
						data-aos="fade-up">
						...
						<div class="row">
								...
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/course/course-40.jpg')}}">
										</a>
										<div class="price">
									...
									<div class="course-content">
										...
										<h3 class="title"><a href="course-details.html">Information About UI/UX Design
												Degree</a></h3>
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<a href="checkout.html"
												class="btn btn-primary btn-xl d-inline-flex align-items-center"><i
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/course/course-41.jpg')}}">
										</a>
										<div class="price">
											<h3>$156</h3>
										</div>
									...
									<div class="course-content">
										...
										<h3 class="title"><a href="course-details.html">Wordpress for Beginners - Master
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/course/course-42.jpg')}}">
										</a>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/course/course-43.jpg')}}">
										</a>
										<div class="price">
											<h3>$145</h3>
										</div>
									...
									<div class="course-content">
										...
										<h3 class="title"><a href="course-details.html">Learn Angular Fundamentals From
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/course/course-45.jpg')}}">
										</a>
										<div class="price combo">
											<h3>Free</h3>
										</div>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									<div class="course-img">
										<a href="course-details.html">
											<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/course/course-44.jpg')}}">
										</a>
										<div class="price combo">
											<h3>$200 <span>$990.00</span></h3>
										</div>
									...
									<div class="course-content">
										...
										<h3 class="title"><a href="course-details.html">C# Developers Double Your Coding
					...
					<div class="row align-items-end">
							...
							<div class="career-group aos" data-aos="fade-up">
								<div class="row row-gap-4">
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img ">
												<img src="{{web_resource_url('assets/img/icons/icon-22.svg')}}" alt="Img" class="img-fluid">
											</div>
									...
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img ">
												<img src="{{web_resource_url('assets/img/icons/icon-17.svg')}}" alt="Img" class="img-fluid">
											</div>
									...
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img "><img src="{{web_resource_url('assets/img/icons/icon-23.svg')}}"
									...
									<div class="col-lg-6 col-md-6 d-flex">
										<div class="certified-item d-flex align-items-center flex-fill">
											<div class="certified-img ">
												<img src="{{web_resource_url('assets/img/icons/icon-16.svg')}}" alt="Img" class="img-fluid">
											</div>
						...
						<div class="col-lg-6 col-md-12">
							<div class="career-img aos" data-aos="fade-up">
								<img src="{{web_resource_url('assets/img/bg/bg-2.png')}}" alt="Img" class="img-fluid master-bg">
								<img src="{{web_resource_url('assets/img/feature/feature-16.png')}}" alt="Img" class="img-fluid girl-img">
								<img src="{{web_resource_url('assets/img/icons/icon-18.svg')}}" alt="Img" class="img-fluid float-img-01">
								<img src="{{web_resource_url('assets/img/icons/icon-19.svg')}}" alt="Img" class="img-fluid float-img-02">
								<img src="{{web_resource_url('assets/img/icons/icon-20.svg')}}" alt="Img" class="img-fluid float-img-03">
								<img src="{{web_resource_url('assets/img/icons/icon-21.svg')}}" alt="Img" class="img-fluid float-img-04">
							</div>
						</div>
					</div>
				</div>
								...
								<div class="course-item course-item-three mx-0 flex-fill aos" data-aos="fade-up">
									...
									<div class="course-content">
										<div class="course-user">
											<div class="course-user-img">
												<a href="instructor-profile.html"><img
														src="{{web_resource_url('assets/img/avatar/avatar-27.jpg')}}" alt="Img"
														class="img-fluid"></a>
												<div class="course-name">
										...
										<div class="course-info d-flex align-items-center">
											<div class="course-lesson d-flex align-items-center">
												<img src="{{web_resource_url('assets/img/icons/icon-3.svg')}}" alt="Img" class="img-fluid">
												<p>13+ Lesson</p>
											</div>
											<div class="course-time d-flex align-items-center">
												<img src="{{web_resource_url('assets/img/icons/icon-4.svg')}}" alt="Img" class="img-fluid">
												<p>10hr 30min</p>
											</div>
										</div>
										<div class="d-flex align-items-center justify-content-between">
						...
						<div class="instructors-course aos" data-aos="fade-up">
							<div class="instructor-item instructor-item-two">
								<div class="instructors-img">
									...
									<div
										class="position-absolute end-0 bottom-0 d-flex align-items-start w-100 z-index-2 p-3">
								...
								<div class="instructor-content">
									...
									<div class="student-count">
										<i class="isax isax-profile-2user5 text-secondary me-2"></i><span>50
											Students</span>
									</div>
								</div>
							</div>
							<div class="instructor-item instructor-item-two">
								...
								<div class="instructor-content">
									...
									<div class="student-count">
										<i class="isax isax-profile-2user5 text-warning me-2"></i><span>60
											Students</span>
									</div>
								</div>
							</div>
							<div class="instructor-item instructor-item-two">
								...
								<div class="instructor-content">
									...
									<span class="designation">Web Developer</span>
									<div class="student-count">
										<i class="isax isax-profile-2user5 text-primary me-2"></i><span>40
											Students</span>
									</div>
								</div>
							</div>
							<div class="instructor-item instructor-item-two">
								...
								<div class="instructor-content">
									...
									<div class="student-count">
										<i class="isax isax-profile-2user5 text-danger me-2"></i><span>50
											Students</span>
									</div>
								</div>
							</div>
				...
				<div class="container">
					...
					<div class="lead-group aos" data-aos="fade-up">
						<div class="lead-group-slider owl-carousel owl-theme">
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/22.svg')}}">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/23.svg')}}">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/24.svg')}}">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/25.svg')}}">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/26.svg')}}">
								</div>
							</div>
							<div class="item">
								<div class="lead-img">
									<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/27.svg')}}">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row align-items-center row-gap-4">
						<div class="col-md-6">
							<div class="knowledge-img aos" data-aos="fade-up">
								<img src="{{web_resource_url('assets/img/feature/feature-17.svg')}}" alt="Img" class="img-fluid">
							</div>
						</div>
						<div class="col-md-6 d-flex align-items-center">
							<div class="join-mentor aos" data-aos="fade-up">
								...
								<ul class="list-unstyled mb-4">
									...
									<li class="d-flex mb-3">
										<i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Flexible Course
										Plan
									</li>
									<li class="d-flex mb-3">
									...
									<li class="d-flex mb-3">
										<i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>The Most World
										Class Instructors
									</li>
								</ul>
								<div>
			...
			<div class="testimonial-four">
				<div class="review">
					<div class="container">
						<div class="section-header text-center aos" data-aos="fade-up">
							<span class="fw-medium text-white fs-18 fw-bold mb-2 d-inline-block">Check out these real
								reviews</span>
							...
							<div class="d-flex justify-content-center">
								<div class="testimonial-all">
									<div class="testimonial-quotes">
										<img src="{{web_resource_url('assets/img/icons/icon-28.png')}}" alt="Img">
									</div>
									<div class="testimonial-content text-center align-items-center d-flex">
										<div class="testimonial-info ">
											<div class="testimonial-icon">
												<img src="{{web_resource_url('assets/img/icons/icon-29.png')}}" alt="Img">
											</div>
											<p>I really appreciated my mentor’s insight, but sometimes I felt
												overwhelmed by the amount of information they provided. It would have
												been helpful to focus on one or two areas at a time rather than trying
			...
			<div class="section become-instructors aos" data-aos="fade-up">
				<img src="{{web_resource_url('assets/img/bg/bg-5.png')}}" alt="" class="img-fluid become-instructors-bg1">
				<img src="{{web_resource_url('assets/img/bg/bg-6.png')}}" alt="" class="img-fluid become-instructors-bg2">
				<div class="container">
									...
									<div class="col-lg-7 col-md-12">
										<div class="top-instructors">
											...
											<a href="become-an-instructor.html"
												class="btn btn-secondary btn-xl">Register as Instructor</a>
										</div>
									</div>
									<div class="col-lg-5 col-md-12">
										<div class="mentor-img">
											<img class="img-fluid d-none d-lg-flex" alt="Img"
												src="{{web_resource_url('assets/img/feature/feature-15.svg')}}">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-lg-5 col-md-12">
										<div class="mentor-img d-none d-lg-flex">
											<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/feature/feature-14.svg')}}">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="container">
					...
					<div class="row row-gap-4 justify-content-center">
							...
							<div class="blog-wrap shadow-sm mb-0">
								<div class="blog-img">
									<a href="blog-grid.html">
										<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/blog/blog-40.jpg')}}">
									</a>
								</div>
								<div class="blog-content">
									...
									<h5><a href="blog-grid.html">How to Find the Perfect Mentor for Your Academic
											Journey</a></h5>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-lg-4">
							<div class="blog-wrap shadow-sm mb-0">
								<div class="blog-img">
									<a href="blog-grid.html">
										<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/blog/blog-41.jpg')}}">
									</a>
								</div>
								<div class="blog-content">
									<div class="blog-info mb-3">
						...
						<div class="col-md-6 col-lg-4">
							<div class="blog-wrap shadow-sm mb-0">
								<div class="blog-img">
									<a href="blog-grid.html">
										<img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/blog/blog-42.jpg')}}">
									</a>
								</div>
								<div class="blog-content">
									<div class="blog-info mb-3">
									...
									<h5><a href="blog-grid.html">11 Tips to Help You Get New Clients with the design
											knowledge</a></h5>
								</div>
							</div>
						</div>
					...
					<div class="enroll-group aos" data-aos="fade-up">
						<div class="row row-gap-3 justify-content-center">
							<div class="col-lg-4 col-md-6">
								<div class="enroll-course d-flex align-items-center">
									<div class="enroll-img">
										<img src="{{web_resource_url('assets/img/icons/icon-5.svg')}}" alt="Img" class="img-fluid">
									</div>
							...
							<div class="col-lg-4 col-md-6">
								<div class="enroll-course d-flex align-items-center">
									<div class="enroll-img ">
										<img src="{{web_resource_url('assets/img/icons/icon-6.svg')}}" alt="Img" class="img-fluid">
									</div>
									<div class="course-count">
							...
							<div class="col-lg-4 col-md-6">
								<div class="enroll-course d-flex align-items-center">
									<div class="enroll-img ">
										<img src="{{web_resource_url('assets/img/icons/icon-7.svg')}}" alt="Img" class="img-fluid">
									</div>
									<div class="course-count">
					...
					<div class="lab-course">
						<div class="client-slider aos" data-aos="fade-up">
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-8.svg')}}" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-9.svg')}}" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-10.svg')}}" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-11.svg')}}" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-12.svg')}}" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-13.svg')}}" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-14.svg')}}" alt="Img" class="img-fluid">
							</div>
							<div>
								<img src="{{web_resource_url('assets/img/icons/icon-15.svg')}}" alt="Img" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
							...
							<div class="col-lg-4 col-md-12">
								...
								<div class="footer-widget footer-about">
									<div class="footer-logo">
										<img class="logo-max-200" src="{{web_resource_url('assets/img/logo-black.png')}}" alt="logo">
									</div>
									<div class="footer-about-content">
										<p>Platform designed to help organizations, educators, and learners manage,
											deliver, and track learning and training activities.</p>
									</div>
									<div class="d-flex align-items-center gap-2 flex-wrap d-none">
										<a href="javascript:void(0);"><img src="{{web_resource_url('assets/img/icons/appstore.svg')}}" alt=""
												class="img-fluid"></a>
										<a href="javascript:void(0);"><img src="{{web_resource_url('assets/img/icons/googleplay.svg')}}" alt=""
												class="img-fluid"></a>
									</div>
								</div>
								<!-- /Footer Widget -->
									...
									<div class="col-lg-3 col-md-6">
										...
										<div class="footer-widget footer-menu">
											...
											<ul>
												...
												<li class=" d-none"><a href="course-category.html">Services</a></li>
												<li><a href="{{route('page', ['page' => 'about-us.html'])}}">About Us</a></li>
												<li><a href="{{route('page', ['page' => 'faq.html'])}}"">FAQ</a></li>
						...
						<div class="row row-gap-3">
							<div class="col-md-4">
								<div class="copyright-text">
									<p>Copyright 2025 © <a href="javascript:void(0);">Jockey Club Bright Start Project</a>. All
										right reserved.
									</p>
								</div>
							</div>
							<div class="col-md-4">
								<div class="d-flex align-items-center justify-content-center gap-2">
									<a href="javascript:void(0);">
										<img src="{{web_resource_url('assets/img/icons/fb.svg')}}" alt="facebook" class="img-fluid">
									</a>
									<a href="javascript:void(0);">
										<img src="{{web_resource_url('assets/img/icons/instagram.svg')}}" alt="facebook" class="img-fluid">
									</a>
									<a href="javascript:void(0);">
										<img src="{{web_resource_url('assets/img/icons/be.svg')}}" alt="facebook" class="img-fluid">
									</a>
									<a href="javascript:void(0);">
										<img src="{{web_resource_url('assets/img/icons/linkedin.svg')}}" alt="facebook" class="img-fluid">
									</a>
									<a href="javascript:void(0);">
										<img src="{{web_resource_url('assets/img/icons/x.svg')}}" alt="facebook" class="img-fluid">
									</a>
								</div>
							</div>
							<div class="col-md-4">
