...
<div class="main-wrapper index-six">
                    ...
                    <div class="header-btn d-flex align-items-center">
                        <div class="icon-btn me-2 d-none">
                            <a href="#" class="bg-white dropdown-toggle" data-bs-toggle="dropdown"
                               aria-expanded="false"><img class="rounded-pill" src="{{web_resource_url('assets/img/flags/us-flag.svg')}}"
                                                          alt="flag"></a>
                            <ul class="dropdown-menu p-2 mt-2" style="">
                                <li class="mb-2">
                                    <a class="dropdown-item w-100 rounded d-flex align-items-center"
                                       href="javascript:void(0);">
                                        <img src="{{web_resource_url('assets/img/flags/us-flag.svg')}}" class="me-2" alt="flag">ENG
                                    </a>
                                </li>
                        ...
                        <div class="icon-btn me-2 d-none">
                            <a href="javascript:void(0);" id="dark-mode-toggle"
                               class="theme-toggle activate bg-white">
                        ...
                        <div class="icon-btn me-3 d-none">
                            <a href="#" class="bg-white text-primary position-relative"><i
                                    class="isax isax-shopping-cart5"></i>
                                <span
                                    class="count-icon bg-success p-2 rounded-pill text-white fs-10 fw-bold">1</span>
                            </a>
                        </div>
                        <div>
                            <a href="login.html" class="btn btn-primary d-inline-flex align-items-center me-2 px-3">
                                Sign In</a>
                        </div>
                        <a href="register.html" class="btn btn-secondary me-0 px-3">
                            Register</a>
                    </div>
                </div>
            </div>
        ...
        <section class="home-slide-five">
            <div class="container">
                    ...
                    <div class="col-xl-5 col-lg-6 col-12">
                        <div class="home-slide-five-face" data-aos="fade-down">
                            ...
                            <div class="home-slide-five-text">
									<span class="text-warning d-inline-flex fw-semibold text-uppercase mb-3">The Leader
										in Online Learning</span>
                                <h1 class="text-white mb-4">Engaging & Accessible Online Courses For All</h1>
                                <p class="text-white fs-lg text-center text-md-start pb-2 pb-md-3 mb-4">Trusted by
                                    over 15K Users worldwide since 2022</p>
                            </div>
                            <!-- /Banner Text -->
                            ...
                            <div class="row">
                                <div class="col-lg-6 align-self-end">
                                    <div class="ban-img-1" data-aos="fade-up">
                                        <img src="{{web_resource_url('assets/img/hero/hero-7.png')}}" alt="img">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="ban-img-2" data-aos="fade-down">
                                        <img class="ban-shape2" data-aos="fade-down" data-aos-delay="250"
                                             src="{{web_resource_url('assets/img/shapes/dot-group.png')}}" alt="img">
                                        <img class="ban-shape3" data-aos="fade-down" data-aos-delay="300"
                                             src="{{web_resource_url('assets/img/banner/ban-shape-2.svg')}}" alt="img">
                                        <img class="ban-shape4" data-aos="fade-down" data-aos-delay="350"
                                             src="{{web_resource_url('assets/img/banner/ban-shape-3.svg')}}" alt="img">
                                        <img src="{{web_resource_url('assets/img/hero/hero-8.png')}}" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="vector-shapes-five d-none d-lg-flex">
                    <img src="{{web_resource_url('assets/img/bg/banner-vector.svg')}}" alt="Img">
                </div>
            </div>
        </section>
        <!-- /Home Banner -->
                ...
                <div class="col-lg-8 col-md-6" data-aos="fade-down">
                    <div class="lead-group-five">
                        <div class="leading-slider-five">
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-28.svg')}}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-29.svg')}}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-30.svg')}}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-31.svg')}}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
                                    <img class="img-fluid" alt="Img" src="{{web_resource_url('assets/img/client/client-32.svg')}}">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lead-img">
            ...
            <div class="home-five-course aos">
                    ...
                    <div class="categories-icon">
                        <div class="icon-bg">
                            <a href="course-category.html">
                                <img src="{{web_resource_url('assets/img/icon/framework-01.svg')}}" alt="Img">
                            </a>
                        </div>
                    </div>
                    <h3 class="title"><a href="course-category.html">Angular</a></h3>
                    <p>50 Instructors</p>
                    <a href="course-category.html" class="view-icon"><i class="fas fa-chevron-right"></i></a>
                </div>
                <!-- /Carousel Item  -->
                ...
                <div class="categories-item categories-item-six" data-aos="fade-down">
                    <div class="categories-icon">
                        <div class="icon-bg">
                            <a href="course-category.html">
                                <img src="{{web_resource_url('assets/img/icon/framework-02.svg')}}" alt="Img">
                            </a>
                        </div>
                    </div>
                    <h3 class="title"><a href="course-category.html">React JS</a></h3>
                    <p>50 Instructors</p>
                    <a href="course-category.html" class="view-icon"><i class="fas fa-chevron-right"></i></a>
                </div>
                <!-- /Carousel Item  -->
                ...
                <div class="categories-item categories-item-six" data-aos="fade-down">
                    <div class="categories-icon">
                        <div class="icon-bg">
                            <a href="course-category.html">
                                <img src="{{web_resource_url('assets/img/icon/framework-03.svg')}}" alt="Img">
                            </a>
                        </div>
                    </div>
                    <h3 class="title"><a href="course-category.html">Node JS</a></h3>
                    <p>30 Instructors</p>
                    <a href="course-category.html" class="view-icon"><i class="fas fa-chevron-right"></i></a>
                </div>
                <!-- /Carousel Item  -->
                ...
                <div class="categories-item categories-item-six" data-aos="fade-down">
                    <div class="categories-icon">
                        <div class="icon-bg">
                            <a href="course-category.html">
                                <img src="{{web_resource_url('assets/img/icon/framework-04.svg')}}" alt="Img">
                            </a>
                        </div>
                    </div>
                    <h3 class="title"><a href="course-category.html">Docker</a></h3>
                    <p>60 Instructors</p>
                    <a href="course-category.html" class="view-icon"><i class="fas fa-chevron-right"></i></a>
                </div>
                <!-- /Carousel Item  -->
    ...
    <section class="featured-section-five">
        <div class="container">
                        ...
                        <div class="ux-design-five">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 d-flex">
                                    <div class="course-item course-item-three mx-0 flex-fill aos"
                                         data-aos="fade-up">
                                        <div class="course-img">
                                            <a href="course-details.html">
                                                <img class="img-fluid" alt="Img"
                                                     src="{{web_resource_url('assets/img/course/course-40.jpg')}}">
                                            </a>
                                            <div class="price">
                                        ...
                                        <div class="course-content">
                                            <div class="course-user">
                                                <div class="course-user-img">
                                                    <a href="instructor-profile.html"><img
                                                            src="{{web_resource_url('assets/img/avatar/avatar-21.jpg')}}" alt="Img"
                                                            class="img-fluid"></a>
                                            ...
                                            <div class="course-info d-flex align-items-center">
                                                <div class="course-lesson d-flex align-items-center">
                                                    <img src="{{web_resource_url('assets/img/icons/icon-3.svg')}}" alt="Img">
                                                    <p>12+ Lesson</p>
                                                </div>
                                                <div class="course-time d-flex align-items-center">
                                                    <img src="{{web_resource_url('assets/img/icons/icon-4.svg')}}" alt="Img">
                                                    <p>9hr 30min</p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <a href="checkout.html"
                                                   class="btn btn-primary btn-xl d-inline-flex align-items-center flex-shrink-0"><i
                                                        class="isax isax-shopping-cart5 me-2"></i>Buy Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 d-flex">
                                    <div class="course-item course-item-three mx-0 flex-fill aos"
                                        ...
                                        <div class="course-img">
                                            <a href="course-details.html">
                                                <img class="img-fluid" alt="Img"
                                                     src="{{web_resource_url('assets/img/course/course-02.jpg')}}">
                                            </a>
                                            <div class="price">
                                                <h3>$156</h3>
                                            </div>
                                        ...
                                        <div class="course-content">
                                            <div class="course-user">
                                                <div class="course-user-img">
                                                    <a href="instructor-profile.html"><img
                                                            src="{{web_resource_url('assets/img/avatar/avatar-22.jpg')}}" alt="Img"
                                                            class="img-fluid"></a>
                                                    <div class="course-name">
                                ...
                                <div class="col-lg-4 col-md-6 d-flex">
                                    <div class="course-item course-item-three mx-0 flex-fill aos"
                                        ...
                                        <div class="course-img">
                                            <a href="course-details.html">
                                                <img class="img-fluid" alt="Img"
                                                     src="{{web_resource_url('assets/img/course/course-03.jpg')}}">
                                            </a>
                                        ...
                                        <div class="course-content">
                                            <div class="course-user">
                                                <div class="course-user-img">
                                                    <a href="instructor-profile.html"><img
                                                            src="{{web_resource_url('assets/img/avatar/avatar-25.jpg')}}" alt="Img"
                                                            class="img-fluid"></a>
                                                    <div class="course-name">
                                ...
                                <div class="col-lg-4 col-md-6 d-flex">
                                    <div class="course-item course-item-three mx-0 flex-fill aos"
                                        ...
                                        <div class="course-img">
                                            <a href="course-details.html">
                                                <img class="img-fluid" alt="Img"
                                                     src="{{web_resource_url('assets/img/course/course-04.jpg')}}">
                                            </a>
                                            <div class="price">
                                                <h3>$145</h3>
                                            </div>
                                        ...
                                        <div class="course-content">
                                            <div class="course-user">
                                                <div class="course-user-img">
                                                    <a href="instructor-profile.html"><img
                                                            src="{{web_resource_url('assets/img/avatar/avatar-24.jpg')}}" alt="Img"
                                                            class="img-fluid"></a>
                                                    <div class="course-name">
                                                        <h4><a href="instructor-profile.html">Nicole Brown</a></h4>
                                                        <p>Instructor</p>
                                ...
                                <div class="col-lg-4 col-md-6 d-flex">
                                    <div class="course-item course-item-three mx-0 flex-fill aos"
                                        ...
                                        <div class="course-img">
                                            <a href="course-details.html">
                                                <img class="img-fluid" alt="Img"
                                                     src="{{web_resource_url('assets/img/course/course-13.jpg')}}">
                                            </a>
                                            <div class="price combo">
                                                <h3>Free</h3>
                                            </div>
                                        ...
                                        <div class="course-content">
                                            <div class="course-user">
                                                <div class="course-user-img">
                                                    <a href="instructor-profile.html"><img
                                                            src="{{web_resource_url('assets/img/avatar/avatar-23.jpg')}}" alt="Img"
                                                            class="img-fluid"></a>
                                                    <div class="course-name">
                                ...
                                <div class="col-lg-4 col-md-6 d-flex">
                                    <div class="course-item course-item-three mx-0 flex-fill aos"
                                        ...
                                        <div class="course-img">
                                            <a href="course-details.html">
                                                <img class="img-fluid" alt="Img"
                                                     src="{{web_resource_url('assets/img/course/course-44.jpg')}}">
                                            </a>
                                            <div class="price combo">
                                                <h3>$200 <span>$990.00</span></h3>
                                            </div>
                                        ...
                                        <div class="course-content">
                                            <div class="course-user">
                                                <div class="course-user-img">
                                                    <a href="instructor-profile.html"><img
                                                            src="{{web_resource_url('assets/img/avatar/avatar-26.jpg')}}" alt="Img"
                                                            class="img-fluid"></a>
                                                    <div class="course-name">
                                                        <h4><a href="instructor-profile.html">Stella Johnson</a>
                                                        </h4>
                                                        <p>Instructor</p>
                                                    </div>
                                                </div>
            ...
            <div class="text-center">
                <a href="course-grid.html" class="btn btn-xl btn-primary mt-2" data-aos="fade-up">See More
                    Courses</a>
            </div>
        </div>
    </section>
                    ...
                    <div class="section-five-sub">
                        ...
                        <div class="career-five-content">
                            <p data-aos="fade-down">Get certified, master modern tech skills, and level up your
                                career — whether you’re starting out or a seasoned pro. 95% of eLearning learners
                                report our hands-on earning learners report our hands-on </p>
                        </div>
                        <div class="d-flex align-items-center">
                            <a href="course-list.html" class="btn btn-primary me-2">Join Course</a>
                            <a href="course-list.html" class="btn btn-secondary">Learn More</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon bg-success">
                                    <img src="{{web_resource_url('assets/img/icon/skill-01.svg')}}" alt="Stay motivated">
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon bg-skyblue">
                                    <img src="{{web_resource_url('assets/img/icon/skill-02.svg')}}" alt="Stay motivated">
                                </div>
                                <div class="skill-five-content">
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon bg-danger">
                                    <img src="{{web_resource_url('assets/img/icon/skill-03.svg')}}" alt="Stay motivated">
                                </div>
                                <div class="skill-five-content">
                        ...
                        <div class="col-lg-6 col-sm-6" data-aos="fade-down">
                            <div class="skill-five-item">
                                <div class="skill-five-icon bg-info">
                                    <img src="{{web_resource_url('assets/img/icon/skill-04.svg')}}" alt="Stay motivated">
                                </div>
                                <div class="skill-five-content">
                ...
                <div class="col-lg-6" data-aos="fade-down">
                    <div class="experienced-five-group">
                        <div class="instructor-vector-left">
                            <img src="{{web_resource_url('assets/img/bg/instructor-vector-left.svg')}}" alt="Img">
                        </div>
                        <div class="developer-five-list">
                            <ul>
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-01.jpg')}}" alt="Course Instructor">
                                        </div>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-02.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-03.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-04.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-05.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-06.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-07.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-08.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-09.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-10.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-11.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-12.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-13.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-14.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-15.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                                ...
                                <li class="column-img">
                                    <div class="developer-profile-five">
                                        <div class="developer-image">
                                            <img src="{{web_resource_url('assets/img/user/user-16.jpg')}}" alt="Course Instructor">
                                        </div>
                                        <div class="profile-five-ovelay">
                                            <h5>Daziy Millar</h5>
                                            <p>PHP Expert</p>
                        ...
                        <div class="instructor-vector-right">
                            <img src="{{web_resource_url('assets/img/bg/instructor-vector-right.svg')}}" alt="Img">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-aos="fade-down">
                    <div class="experienced-five-sub">
                        ...
                        <div class="career-five-content">
                            <p class="ex-five-content">An award-winning course management system (CMS) or program is
                                typically recognized for its exceptional quality, innovation, and effectiveness in
                                helping both instructors and students succeed. Here's a breakdown of what makes a
                                course management program stand out, along with examples of course topics and
                                instructors that could be part of such a system.</p>
                        </div>
                        <a href="instructor-list.html" class="btn btn-secondary btn-md">Register Now</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="section-five-sub">
                        ...
                        <ul class="list-unstyled heading-color mb-4">
                            <li class="d-flex mb-3">
                                <i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>Access Your Class
                                anywhere
                            </li>
                            <li class="d-flex mb-3">
                            ...
                            <li class="d-flex mb-3 aos-init aos-animate">
                                <i class="isax isax-tick-circle5 text-success fs-24 me-2"></i>The Most World Class
                                Instructors
                            </li>
                        </ul>

                        <a href="course-list.html" class="btn btn-primary">Start Teaching Today</a>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12" data-aos="fade-down">
                    <div class="joing-count-five text-center">
                        <div class="joing-count-image">
                            <img src="{{web_resource_url('assets/img/feature/feature-7.png')}}" alt="Img">
                            <img src="{{web_resource_url('assets/img/shapes/dot-2.svg')}}" alt="img" class="joing-count-img1">
                            <img src="{{web_resource_url('assets/img/shapes/half-circle.svg')}}" alt="img" class="joing-count-img2">
                        </div>
    ...
    <section class="testimonial-section-five">
        <img src="{{web_resource_url('assets/img/shapes/quote.png')}}" class="d-none d-lg-flex testimonials-quote" alt="Img">
        <div class="container">
            <div class="header-five-title text-center" data-aos="fade-down">
                        ...
                        <div class="testimonial-item-six">
                            <div class="testimonial-content-five">
                                <div class="testimonial-text">
                                    <h5 class="mb-3">Exactly what I was looking for. You will not regret it. It
                                        really saves me time and effort. Skill is what our business lacked."</h5>
                                    <p class="mb-3">Thank you very much for your help. This is exactly what I was
                                        looking for. You will not regret it. It really saves me time and effort.
                                        Skill is what our business lacked. Thank you very much for your help. This
                                        is exactly what I was look.</p>
                                </div>
                                <div
                            ...
                            <div class="testimonial-image">
                                <img src="{{web_resource_url('assets/img/testimonial/testimonials-1.png')}}" alt="Img">
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-carousel">
                        <div class="testimonial-item-six">
                            <div class="testimonial-content-five">
                                <div class="testimonial-text">
                                    <p class="mb-3">"Thank you very much for your help. This is exactly what I was
                                        looking for. You will not regret it. It really saves me time and effort.
                                        Skill is what our business lacked. Thank you very much for your help. This
                                        is exactly what I was looking for. You will not regret it. It really saves
                                        me time and effort. Skill is what our business lacked."</p>
                                </div>
                                <div
                                    class="testimonial-users-group d-flex align-items-center justify-content-between">
                                    <div class="testimonial-users">
                            ...
                            <div class="testimonial-image">
                                <img src="{{web_resource_url('assets/img/testimonial/testimonial-02.png')}}" alt="Img">
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-carousel">
                        <div class="testimonial-item-six">
                            ...
                            <div class="testimonial-image">
                                <img src="{{web_resource_url('assets/img/testimonial/testimonial-03.png')}}" alt="Img">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="blogs-section-five">
        <div class="container">
            ...
            <div class="home-five-blog">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <h5><a href="blog-details.html">Mastering Programming with a Technical Mentor</a>
                                </h5>
                                <p>Learning to code can be overwhelming, but a mentor can make the journey
                                    smoother....</p>
                                <div class="blog-user d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 d-flex align-items-center">by <a href="javascript:void(0);"
                                                                                        class="link-info text-decoration-underline ms-1">Reni Sarow</a></p>
                                    </div>
                                    <p class="d-flex align-items-center"><i
                                            class="isax isax-calendar-1 text-gray-7 me-2"></i>09 Aug 2025</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <h5><a href="blog-details.html">How to Level Up Your Coding Skills with the Help of
                                        a Mentor</a></h5>
                                <p>Whether you're a beginner or an advanced coder, this blog will explore how....
                                </p>
                                <div class="blog-user d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar me-2">
                                        ...
                                        <p class="mb-0 d-flex align-items-center">by <a href="javascript:void(0);"
                                                                                        class="link-info text-decoration-underline ms-1">Chris Daniel</a>
                                        </p>
                                    </div>
                                    <p class="d-flex align-items-center"><i
                                            class="isax isax-calendar-1 text-gray-7 me-2"></i>15 Jul 2025</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <h5><a href="blog-details.html">Navigating the Tech World: The Ultimate Guide</a>
                                </h5>
                                ...
                                <div class="blog-user d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 d-flex align-items-center">by <a href="javascript:void(0);"
                                                                                        class="link-info text-decoration-underline ms-1">Andrew</a></p>
                                    </div>
                                    <p class="d-flex align-items-center"><i
                                            class="isax isax-calendar-1 text-gray-7 me-2"></i>15 Jan 2025</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center">
                    <a href="blog-2-grid.html" class="btn btn-xl btn-primary mt-3">See More Blogs</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                ...
                <div class="row row-gap-3">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 d-none">
                        ...
                        <!-- Footer Widget -->
                        <div class="footer-menu footer-menu-five">
                            <h5 class="footer-title footer-title-five"><i class="fa-sharp fa-solid fa-dash"></i>For
                                Instructor</h5>
                            <ul>
                        ...
                        <div class="footer-menu">
                            ...
                            <div class="footer-widget-five mb-3">
                                <div class="box-form-newsletter">
                                    <form class="form-newsletter">
                                        <input class="input-newsletter" type="email"
                            ...
                            <div class="d-flex align-items-center gap-3 flex-wrap d-none">
                                <a href="javascript:void(0);">
                                    <img src="{{web_resource_url('assets/img/icon/app-store.svg')}}" alt="img">
                                </a>
                                <a href="javascript:void(0);">
                                    <img src="{{web_resource_url('assets/img/icon/google-play.svg')}}" alt="img">
                                </a>
                            </div>
                            <!-- /Footer Widget -->
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="copyright-text">
                                <p>&copy; 2025 Jockey Club Bright Start Project. All rights reserved.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
