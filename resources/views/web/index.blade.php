                        ...
                        <div class="p-md-t-0 p-md-b-30">
                            <div class="welcome-wrap welcome-wrap-2 p-t-0">
                                <div class="welcome-wrap__inner">
                                    ...
                                    <p class="m-b-15 h3"><i class="fa-solid fa-circle-check text-success mr-1"></i>{{__('HOME4_CONTENT01')}}</p>
                                    <p class="m-b-15 h3"><i class="fa-solid fa-circle-check text-success mr-1"></i>{{__('HOME4_CONTENT02')}}</p>
                                    <p class="m-b-15 h3"><i class="fa-solid fa-circle-check text-success mr-1"></i>{{__('HOME4_CONTENT03')}}</p>
                                    <p class="m-b-15 h3"><i class="fa-solid fa-circle-check text-success mr-1"></i>{{__('HOME4_CONTENT04')}}</p>
