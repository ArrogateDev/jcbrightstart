                                ...
                                <div class="col-md-12">
                                    <div class="input-block">
                                        <label class="form-label">{{__('內容')}}<span
                                                class="text-danger ms-1">*</span></label>
                                        <textarea id="description" name="description" class="form-control tinymce-editor">{!! $resource->description??'' !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div
...
<x-admin.tinymce-editor :height="600" type="resource"/>
