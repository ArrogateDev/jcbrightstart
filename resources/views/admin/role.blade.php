...
<div class="main-wrapper">
                    ...
                    <div class="page-title d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            <a href="#" class="btn btn-secondary" data-bs-toggle="modal"
                               data-bs-target="#form-modal">{{__('新增角色')}}</a>
                        </div>
                    </div>
    ...
    <x-layouts.modal id="form-modal" title="{{__('新增角色')}}" class="modal-lg" form="true" form-id="form">
        <div class="mb-3">
...
<script>
    ...
    $(function () {
        ...
        function resetForm() {
            $modal.find('.modal-header h5').text('{{__('新增角色')}}');
