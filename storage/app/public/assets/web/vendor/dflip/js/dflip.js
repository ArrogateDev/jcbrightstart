...
utils.sanitizeOptions = function(options) {
    options.showThumbnail = utils.parseBoolIfExists(options.showThumbnail);
    ...
    controls_create_class(UI, [
        {
            ...
            value: function init() {
                ...
                if (app.options.showThumbnail === true) {
            ...
            value: function executeCallback(callbackName) {
                if (this.options && typeof this.options[callbackName] === 'function') {
                    try {
                        ...
                        console.error('Error executing callback ' + callbackName + ':', e);
                    }
                }
            }
        },
